...
class Debug:
    def __init__(self, imeDirName):
        ...
        self.jsonNameDict = ({"checj.json": "酷倉", "mscj3.json": "倉頡", "mscj3-ext.json": "倉頡(大字集)", "cj-ext.json": "雅虎倉頡", "cnscj.json": "中標倉頡",
                        "thcj.json": "泰瑞倉頡", "newcj3.json": "亂倉打鳥", "cj5.json": "倉頡五代", "newcj.json": "自由大新倉頡", "scj6.json": "快倉六代", "mxcj3xzj.json": "迷信倉頡 3（小字集）", "mxcj3dzj.json": "迷信倉頡 3（大字集）", "mxcj5nor.json": "迷信倉頡 5（常規）", "mxcj5sup.json": "迷信倉頡 5（擴展）", "mxcj5simp.json": "迷信倉頡 5（簡化字排序）",
