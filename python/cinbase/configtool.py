...
class ConfigHandler(BaseHandler):
    ...
    def load_cindata(self):
        cfg.load()
        CinDict ={}
        CinDict["checj"] = ["checj.json", "mscj3.json", "mscj3-ext.json", "cj-ext.json", "cnscj.json", "thcj.json", "newcj3.json", "cj5.json", "newcj.json", "scj6.json", "cj-fast.json", "mxcj3xzj.json", "mxcj3dzj.json", "mxcj5nor.json", "mxcj5sup.json"]
