...
class LoadRCinTable(threading.Thread):
    def __init__(self, cbTS, RCinTable):
        ...
        self.rcinFileList = ([
                                "checj.json", "mscj3.json", "mscj3-ext.json", "cj-ext.json", "cnscj.json", "thcj.json", "newcj3.json", "cj5.json", "newcj.json", "scj6.json", "cj-fast.json", "mxcj3xzj.json", "mxcj3dzj.json", "mxcj5nor.json", "mxcj5sup.json",
                                ...
                                "liu.json",
                                "ningmaspecial.json", "ningma119.json", "ningmacizu12w7.json", "ningmagaoshou37.json", "huisuwubi11xp.json", "huisuwubi11win7.json", "huisuwubi11baiduo.json", "huisuwubi11pc.json", "huisuwubi11baidun.json"
                            ])
