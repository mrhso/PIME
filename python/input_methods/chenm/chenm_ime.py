...
class CheNMTextService(TextService):
    ...
    def __init__(self, client):
        ...
        self.cinFileList = ["ningmaspecial.json", "ningma119.json", "ningmacizu12w7.json", "ningmagaoshou37.json", "huisuwubi11xp.json", "huisuwubi11win7.json", "huisuwubi11baiduo.json", "huisuwubi11pc.json", "huisuwubi11baidun.json"]
