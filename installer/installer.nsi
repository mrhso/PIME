...
*/
	...
	Section $(RIME) rime
		...
		File "..\python\input_methods\rime\brise\essay\essay.txt"
		File "..\python\input_methods\rime\brise\array\*.yaml"
		File "..\python\input_methods\rime\brise\bopomofo\*.yaml"
		File "..\python\input_methods\rime\brise\cangjie\*.yaml"
		File "..\python\input_methods\rime\brise\combo-pinyin\*.yaml"
		File "..\python\input_methods\rime\brise\double-pinyin\*.yaml"
		File "..\python\input_methods\rime\brise\emoji\*.yaml"
		File "..\python\input_methods\rime\brise\ipa\*.yaml"
		File "..\python\input_methods\rime\brise\jyutping\*.yaml"
		File "..\python\input_methods\rime\brise\luna-pinyin\*.yaml"
		File "..\python\input_methods\rime\brise\middle-chinese\*.yaml"
		File "..\python\input_methods\rime\brise\pinyin-simp\*.yaml"
		File "..\python\input_methods\rime\brise\prelude\*.yaml"
		File "..\python\input_methods\rime\brise\quick\*.yaml"
		File "..\python\input_methods\rime\brise\scj\*.yaml"
		File "..\python\input_methods\rime\brise\soutzoe\*.yaml"
		File "..\python\input_methods\rime\brise\stenotype\*.yaml"
		File "..\python\input_methods\rime\brise\stroke\*.yaml"
		File "..\python\input_methods\rime\brise\terra-pinyin\*.yaml"
		File "..\python\input_methods\rime\brise\wubi\*.yaml"
		File "..\python\input_methods\rime\brise\wugniu\*.yaml"
